...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::WF84N0INZXbHLykM',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::sIEJj5uuBMTQAqKs',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::PS571dgDXOd0JovD',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'customer.quotations.view',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/password/reset/([^/]++)(*:31)|/email/verify/([^/]++)/([^/]++)(*:69)|/customers/profile/(?|([^/]++)(?|(*:109))|change\\-password(*:134)))/?$}sDu',
    ),
    3 => 
    array (
      31 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\HomeController@customerQuotations',
        'controller' => 'App\\Http\\Controllers\\HomeController@customerQuotations',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => NULL,
        'where' => 
        array (
        ),
        'as' => 'customer.quotations.view',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\HomeController@updatepersonal',
        'controller' => 'App\\Http\\Controllers\\HomeController@updatepersonal',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'customers/profile/change-password',
      'action' => 
      array (
        'middleware' => 
        array (
