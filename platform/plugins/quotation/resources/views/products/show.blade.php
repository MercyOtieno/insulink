...
<div class="row">
    <div class="col-sm-12">
        <div class="float-left">
            <a href="{{route('products.index')}}" class="group flex">
                <div
                    class="w-full sm:w-auto inline-flex items-center justify-center text-blue-400 font-medium bg-white bg-opacity-20 group-hover:bg-opacity-30 rounded-lg shadow-sm group-hover:shadow-lg py-3 px-5 border border-white border-opacity-10 transform group-hover:-translate-y-0.5 transition-all duration-150">
                    <svg width="24" height="24" class="text-blue-400 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16l-4-4m0 0l4-4m-4 4h18" />
                    </svg>Back to all Products</div>
            </a>
        </div>
    </div>
    <div class="col-sm-12">
        <div class="vertical-tabs my-4">
            <ul class="nav nav-tabs" role="tablist">
                <h4>Product Menu</h4>
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#pag1" role="tab" aria-controls="home">Product Overview</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#pag2" role="tab" aria-controls="profile">Rates</a>
                </li>
                ...
                <div class="tab-pane active" id="pag1" role="tabpanel">
                    <div class="sv-tab-panel">
                        <div class="card light bordered card-no-padding">
                            <div class="card-header"><h3>Product Overview</h3></div>
                            <div class="card-body">
                                @include('plugins/quotation::products.partials.details')
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="pag2" role="tabpanel">
                    <div class="sv-tab-panel">
                        <div class="card light bordered card-no-padding">
                                    ...
                                    @if ($product->category =='health')
                                        ...
                                        <div class="float-right">
                                            <a class="btn btn-primary btn-lg"
                                                href="{{ route('create.health.rate', $product->id) }}">{{ trans('plugins/quotation::general.rate.button_text') }}</a>
                                        </div>
                                        </div>
                                    @endif
                            ...
                            <div class="card-body">
                                @if ($product->cover_type =='c3' || $product->cover_type =='c6')
                                    @if ($product->motorprivaterates)
                                    <form action="{{route('update.motor.private.rate', $product->motorprivaterates->id)}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="product_id" value="{{$product->motorprivaterates->id}}">
                                        @include('plugins/quotation::products.rates.ratestable')
                                    ...
                                    <div class="body">
                                        <div class="box-wrap-emptyTmpl text-center col-12">
                                            <h1 class="mt20 mb20 ws-nm font-size-emptyDisplayTmpl">{{ trans('plugins/quotation::general.rate.title') }}
                                            </h1>
                                            <p class="text-info-displayTmpl">{{ trans('plugins/quotation::general.rate.description')}}</p>
                                            <div class="empty-displayTmpl-pdtop">
                                                <div class="empty-displayTmpl-image">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 518 270">
                                                        <path fill="#D3DCE6"
                                                        ...
                                                        <g fill="#C3CCD4" opacity=".2">
                                                            <path fill-rule="evenodd" d="M271.085 189.878h137.98v1.705h-137.98z" clip-rule="evenodd"></path>
                                                            <path
                                                        ...
                                                        <path fill="#F7F8FC" fill-rule="evenodd" d="M367.52 157.73l20.763-34.766-60.21-58.105-19.61 60.77"
                                                        ...
                                                        <path fill="#F7F8FC" fill-rule="evenodd"
                                                        ...
                                                        <circle cx="337.135" cy="156.534" r="2.909" fill="#F7F8FC" fill-rule="evenodd" clip-rule="evenodd">
                                                        </circle>
                                                        <path fill="#D3DCE6"
                                                        ...
                                                        <circle cx="302.42" cy="145.656" r="2.909" fill="#F7F8FC" fill-rule="evenodd" clip-rule="evenodd">
                                                        </circle>
                                                        <path fill="#D3DCE6"
                                                        ...
                                                        <g fill="#4FB1C3">
                                                            <path d="M103.822 128.982s6.263 43.636-12.36 69.548c0 0 .023-45.884 12.36-69.548z"></path>
                                                            <path
                                                        ...
                                                        <path fill="#5F5371"
                                                            d="M124.5 218.446H59.827a1.492 1.492 0 1 1 0-2.982h64.67a1.492 1.492 0 0 1 .003 2.982z"></path>
                                                        <path fill="#D6696F"
                                                        ...
                                                        <path fill="#D6696F" d="M331.343 162.12l6.69-56.16"></path>
                                                        <path fill="#E68887"
                                                        ...
                                                        <path fill="#D6696F" d="M347.646 142.74l2.334-36.282"></path>
                                                        <path fill="#E68887"
                                                        ...
                                                        <path fill="#D6696F" d="M346.43 161.624l.794-12.323"></path>
                                                        <path fill="#E68887"
                                                        ...
                                                        <path fill="#FFF" d="M162.695 199.574L139.38 214.82"></path>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#5F5371"
                                                            d="M477.976 213.808h-7.184a1.492 1.492 0 1 1 0-2.982h7.184a1.492 1.492 0 1 1 0 2.982z"></path>
                                                        <path fill="#4FB1C3"
                                                        ...
                                                        <path fill="#A0BF82" d="M452.762 198.052h4.93"></path>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <circle cx="263.578" cy="218.66" r="2.68" fill="#857B98"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <circle cx="278.864" cy="224.77" r="2.68" fill="#857B98"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <circle cx="271.221" cy="221.715" r="2.68" fill="#857B98"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M263.578 218.66l7.643-14.633"></path>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M271.22 221.715l6.76-13.666"></path>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M278.864 224.77l6.237-12.696"></path>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <g fill="#B9BAD5">
                                                            <circle cx="402.713" cy="164.448" r="1.177"></circle>
                                                            <path
                                                        ...
                                                        <circle cx="410.715" cy="150.056" r="2.993" fill="#5F5371"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M410.715 148.536V99.46"></path>
                                                        <path fill="#FBB563"
                                                        ...
                                                        <path fill="#FFF" d="M173.31 223.516h-31.76"></path>
                                                        <path fill="#5F5371"
                                                            d="M173.31 225.007h-31.76a1.492 1.492 0 1 1 0-2.982h31.762a1.492 1.492 0 1 1 0 2.982z"></path>
                                                        <path fill="#E68887"
                                                            d="M146.046 246.538a.994.994 0 0 1-.995-.994V228.02c0-.55.45-.994 1-.994s1 .445 1 .994v17.524a.99.99 0 0 1-.99.994z">
                                                        </path>
                                                        <path fill="#FFF" d="M516.508 253.27H1.492"></path>
                                                        <path fill="#5F5371"
                                                            d="M516.508 254.762H1.492a1.492 1.492 0 1 1 0-2.982h515.016a1.492 1.492 0 1 1 0 2.982z"></path>
                                                        <path fill="#FFF"
                                                        ...
                                                        <g fill="#B9BAD5">
                                                            <circle cx="228.681" cy="247.464" r="1.177"></circle>
                                                            <path
                                                        ...
                                                        <circle cx="236.683" cy="233.072" r="2.993" fill="#5F5371"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M236.683 231.552v-19.236"></path>
                                                        <path fill="#FBB563"
                                                        ...
                                                        <g fill="#B9BAD5">
                                                            <circle cx="107.05" cy="246.713" r=".899"></circle>
                                                            <path
                                                        ...
                                                        <circle cx="113.162" cy="235.719" r="2.287" fill="#5F5371"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M113.162 234.558v-20.57"></path>
                                                        <path fill="#FBB563"
                                                        ...
                                                        <g fill="#B9BAD5">
                                                            <circle cx="473.064" cy="251.562" r=".899"></circle>
                                                            <path
                                                        ...
                                                        <circle cx="479.177" cy="240.569" r="2.287" fill="#5F5371"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M479.177 239.408v-20.57"></path>
                                                        <path fill="#FBB563"
                                                        ...
                                                        <g fill="#B9BAD5">
                                                            <circle cx="170.54" cy="254.807" r=".899"></circle>
                                                            <path
                                                        ...
                                                        <circle cx="176.652" cy="243.814" r="2.287" fill="#5F5371"></circle>
                                                        <path fill="#5F5371"
                                                        ...
                                                        <path fill="#FFF" d="M176.652 242.652V226.31"></path>
                                                        <path fill="#FBB563"
                                            ...
                                            <div class="empty-displayTmpl-btn">
                                                <a class="btn btn-primary btn-lg"
                                                    href="{{ route('create.motor.rate', $product->id) }}">{{ trans('plugins/quotation::general.rate.button_text') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                @elseif ($product->cover_type =='d1')
                                @include('plugins/quotation::products.rates.domesticform')
                                @elseif ($product->category =='health')
                                @include('plugins/quotation::products.rates.medicalform')
                                @else
