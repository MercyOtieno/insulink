...
class QuotationCreateCommercialgeneralcartageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('commercialgeneralcartages', function (Blueprint $table) {
            ...
            $table->string('excess_protector_min')->nullable();
            $table->string('pvt')->nullable();
            $table->string('pvt_min')->nullable();
    ...
    {
        Schema::dropIfExists('commercialgeneralcartages');
    }
}
